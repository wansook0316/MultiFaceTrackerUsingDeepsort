...
def find_face(features, face_db, max_face_threshold):
    ...
    for face in face_db:
        ...
        # cos_harmonic = st.harmonic_mean(list(cos_mat.flatten()))
...
class Track:
    ...
    face_name : string
        기존 데이터 베이스에 존재하는 이름 찾기
    """

    def __init__(self, mean, covariance, track_id, n_init, max_age, face_db, max_face_threshold,
        ...
        if feature is not None:
            ...
            self.face_name = find_face(self.features, face_db, max_face_threshold)
